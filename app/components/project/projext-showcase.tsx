...
import { ArrowTopRight } from "@/app/utils/icons";
import ProjectShowcaseList, {
  type ProjectShowcaseListItem,
} from "@/app/components/project/project-showcase-list";
  ...
  return (
    <section className="overflow-hidden px-6 py-32 sm:px-14 md:px-20">
      <div className="relative mx-auto max-w-7xl">
        ...
        <h2 className="text-xl font-semibold text-accent-foreground sm:text-5xl">
          My projects
        </h2>
          ...
          {props.projects.map((proj) => (
            ...
            >
              <div className="flex gap-2 max-w-3xl">
                ...
                <span
                  key={proj.title}
                  className="-underline-offset-1 text-3xl font-semibold text-accent-foreground underline transition-colors duration-300 sm:text-4xl md:text-5xl lg:hidden"
                >
                  {proj.title}
                </span>
              </div>
